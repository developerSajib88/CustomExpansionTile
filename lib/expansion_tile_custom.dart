      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          if(widget.children.length >= 2)
            Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(16.0, 0, 16.0, 10),
  ...
  Widget build(BuildContext context) {
    ...
    final Widget result = Offstage(
      ...
      child: TickerMode(
        enabled: !closed,
        child: Padding(
          padding: const EdgeInsetsDirectional.fromSTEB(16.0, 10, 16, 10),
          child: Column(
            crossAxisAlignment:
                widget.expandedCrossAxisAlignment ?? CrossAxisAlignment.center,
            children: widget.children.sublist(2),
          ),
        ),
      ),
    );
